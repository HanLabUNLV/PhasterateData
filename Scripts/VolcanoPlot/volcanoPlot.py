...
def main():
    ...
    plt.scatter(xValues, yValues, c="red", edgecolor='', alpha=0.004)
    line = -m.log10(0.05)
    plt.plot([-5, 10], [line, line], linewidth=0.5)

    print "Saving file in high quality..."
    plt.savefig(saveFile + '.' + fileFormat, dpi=200, format=fileFormat)
