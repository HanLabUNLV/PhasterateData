...
\begin{texshade}{sample.fa}
  ...
  \feature{bottom}{0}{\alignmentLength}{bar[-50.0,50.0]:normalized.txt[Blue]}{}
  \showfeaturename{bottom}{P-Score}

  %Extra features may be added by using extra files with different positions.
  %\feature{bbottom}{0}{1..831}{bar[-50.0,50.0]:normalized.txt[Blue]}{}
  %\showfeaturename{bbottom}{Indel-Score}
